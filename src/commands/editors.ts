...
export {
  ...
  hasClaudeCode,
  claudeAdapter,
} from "./editors/adapters/claude.js";
export {
...
} from "./editors/adapters/opencode.js";
export {
  formatClineCommand,
  getClineCommandPath,
  hasCline,
  clineAdapter,
} from "./editors/adapters/cline.js";
export {
  formatCursorCommand,
  ...
  hasCursor,
  cursorAdapter,
} from "./editors/adapters/cursor.js";
export {
  formatPiCommand,
  getPiCommandPath,
  hasPi,
  piAdapter,
} from "./editors/adapters/pi.js";
export {
  formatOmpCommand,
  getOmpCommandPath,
  hasOmp,
