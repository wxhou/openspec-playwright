...
import { hasLegacyTerritoryStart, LEGACY_OPENSPEC_END, LEGACY_OPENSPEC_START, OPENSPEC_START, } from "../../shared/drift.js";
 ...
 */
export function isEditorConfigured(adapter, projectRoot) {
...
export function anyEditorConfigured(adapters, projectRoot) {
 ...
 */
export function agentsFileHasMarkers(projectRoot) {
    ...
    const inner = endIdx !== -1 && endIdx > startIdx
