 ...
 */
function extractRouteFromPath(screenshotPath) {
 ...
 */
async function resolveScreenshots(pattern) {
 ...
 */
function filterBySeverity(anomalies, severityFilter) {
    ...
    if (options.json) {
        ...
        if (result.anomalies.length > 0) {
            ...
            for (const a of result.anomalies) {
                const severityColor = a.severity === "blocking"
                    ? chalk.red
                    : a.severity === "warning"
                        ? chalk.yellow
                        : chalk.gray;
...
//# sourceMappingURL=visionCheck.js.map