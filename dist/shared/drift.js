 ...
 */
export function compareBlock(fileContent, expectedBlock) {
...
export function bundledStandardsPath() {
 ...
 */
export function bundledTemplatePath(rel) {
